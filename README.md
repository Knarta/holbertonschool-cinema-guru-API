...
This is a simple movies API dedicated for Holberton School React Project Holberton School Cinema Guru. The React Cinema Guru client should use **function components and hooks** only — **class components are not allowed**.

## Setting up the backend

### Install Docker

Install Docker for your system: [Get Docker](https://docs.docker.com/get-docker/).

### Install Docker Compose

Docker Desktop includes Compose ([Docker Desktop](https://www.docker.com/products/docker-desktop/)). On Linux, see [Install Docker Compose](https://docs.docker.com/compose/install/).
...
The API is served at **http://localhost:8000**. PostgreSQL is on port **5432** (see `docker-compose.yml` for credentials).
